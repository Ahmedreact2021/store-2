    ...
    <td colspan="2"><div class="menublock">
		...
		<div class="center_menublock">
			<div class="menuitemsblock">
				<div class="menuitemsblock">
					<ul>
						<li style="width:80px"><a href="<?=$path?>?Plink=main"  title="«·—∆Ì”Ì…" >«·—∆Ì”Ì…</a></li>
						<li style="width:80px">
...
<a href="<?=$path?>?Plink=Identity" title="»Ì«‰« Ï" > »Ì«‰« Ï</a>
         
<? }else{?>     
                                   
<a href="<?=$path?>?Plink=help"  title="ﬂÌ› «‘ —ﬂ ø ">
 ﬂÌ› √‘ —ﬂ </a> 
...
<? }?>    
	...
	<a href="<?=$path?>?Plink=balance" title="—’ÌœÌ" >  —’ÌœÌ</a>        
<? }else{?>
 <a href="<?=$path?>?Plink=balance"  title="‘Õ‰ «·—’Ìœ ">
              ‘Õ‰ «·—’Ìœ </a> 	<? }?>   
						...
						<li style="width:80px"><a href="<?=$path?>?Plink=husband" title="«—Ìœ “ÊÃ" >    √—Ìœ “ÊÃ</a> </li>
						<li style="width:80px">
    
                    <a href="<?=$path?>?Plink=wife" title="«—Ìœ “ÊÃ…" >    
                       ...
                       √—Ìœ “ÊÃ…  </a>
                        ...
                        <a href="<?=$path?>?Plink=online"  title="«·„ Ê«Ãœ «·«‰">
             ...
             <a href="<?=$path?>?Plink=agent"  title="Êﬂ·«∆‰«" >
