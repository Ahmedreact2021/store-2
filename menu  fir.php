        ...
        <td><table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <td><table width="100%"  border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  ...
                  <td width="92%" align="right" background="images/icon_menu.jpg" class="textwhite"><span class="style1">&nbsp;</span>&nbsp;&nbsp;</td>
          ...
          <form action="?Plink=search" method="post" name="formSer" onSubmit="return astm_serch()" style="margin-bottom:0; margin-left:0; margin-right:0; margin-top:0 ">                               
				...
				<div class="searchtext_block">
					<div class="style1 searchtext2"><strong>»ÕÀ ⁄‰ «·√⁄÷«¡</strong></div>
...
<input name="Submit" type="image"  value="»ÕÀ"  > 
