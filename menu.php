...
<td rowspan="7" width="340"></td>
  ...
  <tr>
	...
	<? if($Sign=="exp"){?>·« ÌÊÃœ —’Ìœ<br>«‰  «·«‰ ›Ì «·Õ”«» «·„Ã«‰Ì<? }?>
		  	...
		  	<form action="login.php" method="post" name="formsign" style="margin-bottom:0; margin-left:0; margin-right:0; margin-top:0" >
  ...
  <tr>
	...
	<table width="100%"  border="0" cellpadding="0" cellspacing="2">
      ...
      <tr>
        ...
        <td><table width="100%" border="0" align="center" cellpadding="0" cellspacing="2"  class="searchimg">
...
<option dir="rtl"  value="75-80<"   <? if($Age_Ser=="75-80"){?> selected<? }?>>75-80</option>
		...
		<!----------------------------------------------------------------->
           ...
           <td align="right" colspan="2"><input name="Submit" type="image" src="images/searchnow.jpg" title="»ÕÀ" class="screpte"  value="»ÕÀ">
                      
                  
                      
       <? /*/  <script src="selectuser.js"></script>
              <td align="right" colspan="2"><input name="Submit" type="image" src="images/searchnow.jpg" title="»ÕÀ" class="screpte"  value="»ÕÀ" onchange="showUser(this.value)">  /*/ ?>              
          ...
          <tr>
            ...
            <td><table width="100%"  border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  ...
                  <td width="92%" align="right"  background="images/icon_menu.jpg" class="textwhite"><div align="center" class="style1"><strong>«Œ— «·«⁄÷«¡ «·„”Ã·Ì‰ &nbsp;&nbsp;</strong>&nbsp;&nbsp;</div></td>

                  <td width="8%" height="25" align="center"bgcolor="#FF99CC" class="textred">&raquo;</td>
                </tr>
          ...
          <tr>
            ...
            <td><table width="100%"  border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  ...
                  <td width="92%" align="right"  background="images/icon_menu.jpg" class="textwhite"><div align="center" class="style5"><span class="style6">«Œ— «·«⁄÷«¡ œŒÊ· &nbsp;&nbsp;&nbsp;&nbsp;</span>&nbsp;&nbsp;</div></td>
...
<td width="92%" align="right"  background="images/icon_menu.jpg"><div align="center" class="style6">—Ê«»ÿ  Â„ﬂ &nbsp;&nbsp;&nbsp;&nbsp;</div></td>
