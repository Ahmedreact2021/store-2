...
<table width="85%"  align="center" cellpadding="0"  dir="rtl" >
<?  
...
{?>
<td width="180px" background="images/img02.jpg" dir="ltr"><table width="100%"  border="0" cellpadding="0" cellspacing="0" >
  <tr>
...
?>" 
      ...
      <tr>
		...
		<? /*/ <a href='?Plink=profile&id=<?=$row_rand_user[user_id]?>' title='«·„“Ìœ ⁄‰ <?=$row_rand_user[UserName]?>' style='text-decoration:none' class="textred">«·„“Ìœ &raquo; &nbsp;</a> /*/ ?> 
...
/*------------------------------------*/
$x=4;
$rand_user=mysql_query("select * from $Table_usrs  where special='true' and login='true' order by  RAND() LIMIT 24");
...
if($i==13 ){echo "<td align='center' class='sizeadv180_90' valign='middle'   >"?><? adv(Between_Members_buttom_left,'images/180_90.jpg');?><? echo"</td>";}
elseif($i==14  ){echo "<td align='center' class='sizeadv180_90' valign='middle'  >"?><? adv(Between_Members_buttom_right,'images/180_90.jpg');?><? echo"</td>";}
		else{?>
<td width="180px" background="images/back2.jpg" dir="ltr"><table width="100%"  border="0" cellpadding="0" cellspacing="0" >
  <tr>
    <td height="90px" align="left" valign="top" dir="rtl"><table width="100%"  border="0" align="center" cellpadding="0" cellspacing="1">
      <tr><?
...
?>
    ...
    <a href='?Plink=profile&id=<?=$row_rand_user[user_id]?>' title='«·„“Ìœ ⁄‰ <?=$row_rand_user[UserName]?>' style='text-decoration:none' class="textred">«·„“Ìœ &raquo; &nbsp;</a>
        ...
        <a href='?Plink=profile&id=<?=$row_rand_user[user_id]?>' title='«€„“ <?=$row_rand_user[UserName]?>' style='text-decoration:none' class="textred">€„“… &raquo; &nbsp;</a>
    </td>
  </tr>
</table>
  </td><? }?>
